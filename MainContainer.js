        ...
        <div className = 'chat-widget d-flex p-1 m-3'>
            ...
            <div className = 'detail-widget d-flex p-4'>
              <p className = 'd-flex p-3'>
                 <ul className = 'chat-list d-flex p-4 '><a>
                    ...
                    Aenean sed lectus urna. Integer sed ex magna. Integer egestas lectus ut sem finibus consequat. Duis sodales neque vel pellentesque sodales. Fusce condimentum ex eu urna dapibus, sed dapibus nunc condimentum.</a>
                </ul>
              </p>
            </div>
            <div className = 'chatbox-widget d-flex p-4'>
                ...
                <ul className = 'chat-list d-flex p-4 '>
                    ...
                    <div className = 'Answer-container d-flex p-2'>
                    <a>consectetur adipiscing elit. Ut porttitor,
                    urna vel maximus consectetur, arcu quam egestas erat, pulvinar blandit lectus nulla eget risus.
                    Aliquam laoreet,</a> </div>
                    <h5>
                        nibh at pulvinar tincidunt, velit sapien malesuada ex, non feugiat ante ante ut elit.
                    Fusce eu orci ut eros laoreet
                    </h5>
                    <span className = 'span'>Ans:</span>
                    <div className = 'Answer-container d-flex p-2'>
                    <a>viverra et vitae elit. Suspendisse potenti. Etiam pretium vel tellus quis rhoncus.</a></div>
                    <h5> Vivamus in lacus vitae arcu pharetra sollicitudin vitae at dui. Fusce iaculis, nulla eu dignissim iaculis,</h5>
                    <span className = 'span'>Ans:</span>
                    <div className = 'Answer-container d-flex p-2'>
                     <a> odio sapien imperdiet ante, at pretium quam lacus ac mauris. Integer suscipit felis eu tincidunt feugiat. Proin sed ante id magna feugiat condimentum. Ut aliquam lorem nisi, id semper turpis rutrum sit amet. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris vel volutpat nisi.
                    Aenean sed lectus urna. Integer sed ex magna.</a></div>
                </ul>
                </p>
